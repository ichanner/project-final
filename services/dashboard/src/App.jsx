...
const PRESETS = {
  ...
  CoinGecko: {
    ...
    anchor: "the top cryptocurrencies table, one row per coin, with the coin name, current price in USD, 1-hour percentage change, 24-hour percentage change, 7-day percentage change, market capitalization, and 24-hour volume",
    fields: [
      { name: "name",        type: "string", volatile: false },
      { name: "price",       type: "string", volatile: true  },
      { name: "change_1h",   type: "string", volatile: true  },
      { name: "change_24h",  type: "string", volatile: true  },
      { name: "change_7d",   type: "string", volatile: true  },
      { name: "market_cap",  type: "string", volatile: true  },
      { name: "volume_24h",  type: "string", volatile: true  },
    ],
    cron: "* * * * *",
  ...
  GitHubTrending: {
    ...
    anchor: "the list of trending repositories, one entry per repo, with the owner-and-name slug, the repo description, the primary language, total star count, total fork count, and stars gained today",
    fields: [
      { name: "repo",         type: "string", volatile: false },
      { name: "description",  type: "string", volatile: false },
      { name: "language",     type: "string", volatile: false },
      { name: "stars",        type: "string", volatile: true  },
      { name: "forks",        type: "string", volatile: true  },
      { name: "stars_today",  type: "string", volatile: true  },
    ],
    cron: "*/5 * * * *",
  },
};
